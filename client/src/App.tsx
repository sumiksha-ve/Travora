...
function Admin({ section = "overview" }: { section?: string }) { if (section === "requests") return <AdminRequests />; if (section === "bookings") return <AdminBookings />; return <AdminOverview section={section} />; }
