...
function Admin({ section = "overview" }: { section?: string }) { if (section === "requests") return <AdminRequests />; if (section === "bookings") return <AdminBookings />; if (section === "reports") return <AdminReports />; return <AdminOverview section={section} />; }
